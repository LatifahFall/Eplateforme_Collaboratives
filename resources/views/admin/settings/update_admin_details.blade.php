...
<!-- me -->
                  ...
                  encrtype="multipart/form-data">@csrf
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Admin Types</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="admin_mobile" placeholder="Enter 10 digit Mobile Number" name="admin_mobile"
